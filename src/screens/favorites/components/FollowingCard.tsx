...
import type { FollowingProfile } from '@/src/types/favorites.types';
...
/**
 * Following card component for Favorites home screen
 * Profiles have max width so 1-2 profiles don't stretch too wide
 */
    ...
    return (
        <Pressable style={styles.container} onPress={onPress}>
                        ...
                        displayProfiles.map((profile, index) => (
                            <View
                                ...
                                style={[
                                    ...
                                    getImageStyle(index, displayProfiles.length),
                                    getImageWidth(displayProfiles.length),
            ...
            <View style={styles.infoContainer}>
                <Text style={[styles.title, { color: textColor }]}>Following</Text>
